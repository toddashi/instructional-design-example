...
define config.name = _("Instructional Design Example with Renpy")
...
define build.name = "InstructionalDesignExamplewithRenpy"
...
define config.save_directory = "InstructionalDesignExamplewithRenpy-1559968996"
